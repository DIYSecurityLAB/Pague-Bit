      ...
      <div className="container mx-auto px-4 md:px-0">
        ...
        >
          ...
          >
            ...
            <img src="https://placehold.co/300x200/8b5cf6/ffffff?text=Buy+Bitcoin&font=roboto" alt="Compre Bitcoin" className='mt-4 rounded-md'/>
          </motion.div>
          <motion.div
            className="bg-white p-6 rounded-lg shadow-md text-center flex flex-col items-center border border-orange-100"
            variants={item}
          >
            ...
            <img src="https://placehold.co/300x200/3b82f6/ffffff?text=Store+Bitcoin&font=roboto" alt="Armazene Bitcoin" className='mt-4 rounded-md'/>
          </motion.div>
          <motion.div
            className="bg-white p-6 rounded-lg shadow-md text-center flex flex-col items-center border border-orange-100"
            variants={item}
          >
            ...
            <img src="https://placehold.co/300x200/14b8a6/ffffff?text=Accept+Bitcoin&font=roboto" alt="Aceite Bitcoin" className='mt-4 rounded-md'/>
          </motion.div>
        </motion.div>
